...
/*El codigo contine dos tareas que corresponden a dos timers, el timer 1 solo se dispara una vez y el timer 2 se dispara despues del timer 1
el cual se vuelve a activar pasado el tiempo de delay de 1 segundo*/ 